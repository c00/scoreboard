...
export const defaultHotkeys: HotkeyConfig[] = [
	{ shortcut: 'ctrl+shift+t', action: HotkeyAction.TOGGLE_ALL_CLOCKS },
	{ shortcut: 'ctrl+t', action: HotkeyAction.TOGGLE_MAIN_CLOCK },
	{ shortcut: 'ctrl+s', action: HotkeyAction.SWITCH_MAIN_CLOCK },
	{ shortcut: 'ctrl+shift+1', action: HotkeyAction.TOGGLE_PENALTY_CLOCK_1_LEFT },
	{ shortcut: 'ctrl+shift+2', action: HotkeyAction.TOGGLE_PENALTY_CLOCK_2_LEFT },
	{ shortcut: 'ctrl+shift+3', action: HotkeyAction.TOGGLE_PENALTY_CLOCK_1_RIGHT },
	{ shortcut: 'ctrl+shift+4', action: HotkeyAction.TOGGLE_PENALTY_CLOCK_2_RIGHT },
	{ shortcut: 'ctrl+[', action: HotkeyAction.GOAL_LEFT },
	{ shortcut: 'ctrl+]', action: HotkeyAction.GOAL_RIGHT },
	{ shortcut: 'ctrl+\\', action: HotkeyAction.BUZZER },
